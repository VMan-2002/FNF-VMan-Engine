...
class PlayStateMulti extends PlayState
{
	...
	static var localNamesRare:Array<String> = ["The man behind PLAYER's slaughter", "Comically large PLAYER", "Blammed Lights!!", "PLAYER jumpscare", "Trollge GF", "Lullaby GF", "Minus GF", "The cooler PLAYER", "Holiday GF", "Doge GF"];
	...
	public static function secondaryName(name:String) {
		var n:Array<String> = Std.random(260) == 0 ? localNamesRare : localNames;
